...
MC_POSTGRESQL_BIN_DIR="/usr/lib/postgresql/12/bin/"
MC_POSTGRESQL_DATA_DIR="/var/lib/postgresql/12/main/"
MC_POSTGRESQL_CONF_PATH="/etc/postgresql/12/main/postgresql.conf"
